...
export default function Home() {
  ...
  <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                          ...
                          data?.allPerson.map((i) => {
                            return (
                              <tr key={i.id} class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{i.ciudad}</td>
                            </tr>
                            )
                          })
                        }
      ...
      <div id="updateProductModal" tabindex="-1" aria-hidden="true" class=" overflow-y-auto overflow-x-hidden top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
